...
namespace GrassHopperToAxisVM
{
    public class GH_1 : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddParameter(new AxisNodeSupParameter(), "NodeSupport", "AxNS", "Nodesupport", GH_ParamAccess.item);
            pManager[1].Optional = true;
        }

        protected override void RegisterOutputParams(GH_Component.GH_OutputParamManager pManager)
        {
            pManager.AddParameter(new AxisPointParameter(), "AxisVM Point", "AxP", "Points with AxisVM parameters", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            {
                points2.Value.sup = new Structs.AxisNodeSup(0, 0, 0, 0, 0, 0);
            }
            //points2.Value.deleting = true;
            //points2.Value.drawing = true;
            DA.SetData(0,new AxisPoint(points2.Value.point,points2.Value.sup));
        }
