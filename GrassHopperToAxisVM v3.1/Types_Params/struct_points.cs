...
namespace GrassHopperToAxisVM
{
    public partial class structs
    {
        public class AxisPoint 
        {
            ...
            public structs.AxNodalLoad lad;
            public AxisPoint(List<Point3d> point,structs.AxisNodeSup sup,structs.AxNodalLoad lad)
            {
                this.point = point;
                this.sup = sup;
                this.lad = lad;
            ...
            static AxisPoint()
            {
                Default = new AxisPoint(new List<Point3d>(),new structs.AxisNodeSup(),new AxNodalLoad());
            }
        }
    }
    public class AxisPoint : GH_Goo<structs.AxisPoint>
    {
        ...
        public AxisPoint(AxisPoint axMemberSource)
        {
            ...
            this.Value.lad = axMemberSource.Value.lad;
        }
        public AxisPoint(List<Point3d> p, structs.AxisNodeSup sup,structs.AxNodalLoad lad)
        {
            this.Value = new structs.AxisPoint(p,sup,lad);
        }
