...
namespace GrassHopperToAxisVM
{
    public partial class structs
    {
        ...
        {
            public Mesh mesh; public string material; public double thickness; public string crs; public int num;
            public AxisMesh(Mesh mesh, double thickness = 0, string material = null,string crs = null, int num=0)
            {
                this.mesh = mesh;
