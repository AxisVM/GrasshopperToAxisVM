...
namespace GrassHopperToAxisVM
{
    public class GH_1 : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddParameter(new AxNodalLoadParameter(), "Nodal Load", "NL", "Nodal Load", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            AxNodalLoad nl = new AxNodalLoad();
            ...
            if (DA.GetData(2, ref nl))
            {
                points2.Value.lad = new structs.AxNodalLoad(nl.Value.Rx, nl.Value.Ry, nl.Value.Rz, nl.Value.Rxx, nl.Value.Ryy, nl.Value.Rzz);
            }
            else
            {
                points2.Value.lad = new structs.AxNodalLoad(0, 0, 0, 0, 0, 0);
            }
